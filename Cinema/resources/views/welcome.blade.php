@include('includes.cabecalho') <!-- include -->
    ...
    <section class="hero">
      <div class="container">
        ...
        <div class="hero-content">
          ...
          <p class="hero-subtitle">Movie Thriller</p>
        ...
        <ul class="movies-list  has-scrollbar">
            ...
            <div class="movie-card">
              ...
              <a href="./movie-details.html">
                <figure class="card-banner">
                  <img src="{{url('image/upcoming-1.png')}}" alt="The Northman movie poster">
                </figure>
              </a>
          ...
          <li>
            <div class="movie-card">
              ...
              <a href="./movie-details.html">
                <figure class="card-banner">
                  <img src="{{url('image/upcoming-2.png')}}" alt="Doctor Strange in the Multiverse of Madness movie poster">
                </figure>
              </a>
          ...
          <li>
            <div class="movie-card">
              ...
              <a href="./movie-details.html">
                <figure class="card-banner">
                  <img src="{{url('image/upcoming-3.png')}}" alt="Memory movie poster">
                </figure>
              </a>
          ...
          <li>
            <div class="movie-card">
              ...
              <a href="./movie-details.html">
                <figure class="card-banner">
                  <img src="{{url('image/upcoming-4.png')}}" alt="The Unbearable Weight of Massive Talent movie poster">
                </figure>
              </a>
    ...
    <section class="service">
      <div class="container">
        ...
        <div class="service-banner">
          <figure>
            <img src="{{url('image/Cartaz.png')}}" alt="HD 4k resolution! only $3.9" style="width:400px">
          </figure>
        ...
        <ul class="movies-list">
          ...
          <li>
            <div class="movie-card">
              ...
              <a href="./movie-details.html">
                <figure class="card-banner">
                  <img src="{{url('image/movie-1.png')}}" alt="Sonic the Hedgehog 2 movie poster">
                </figure>
              </a>
          ...
          <li>
            <div class="movie-card">
              ...
              <a href="./movie-details.html">
                <figure class="card-banner">
                  <img src="{{url('image/movie-2.png')}}" alt="Morbius movie poster">
                </figure>
              </a>
          ...
          <li>
            <div class="movie-card">
              ...
              <a href="./movie-details.html">
                <figure class="card-banner">
                  <img src="{{url('image/movie-3.png')}}" alt="The Adam Project movie poster">
                </figure>
              </a>
          ...
          <li>
            <div class="movie-card">
              ...
              <a href="./movie-details.html">
                <figure class="card-banner">
                  <img src="{{url('image/movie-4.png')}}" alt="Free Guy movie poster">
                </figure>
              </a>
          ...
          <li>
            <div class="movie-card">
              ...
              <a href="./movie-details.html">
                <figure class="card-banner">
                  <img src="{{url('image/movie-5.png')}}" alt="The Batman movie poster">
                </figure>
              </a>
          ...
          <li>
            <div class="movie-card">
              ...
              <a href="./movie-details.html">
                <figure class="card-banner">
                  <img src=".{{url('image/movie-5.png')}}" alt="Uncharted movie poster">
                </figure>
              </a>
          ...
          <li>
            <div class="movie-card">
              ...
              <a href="./movie-details.html">
                <figure class="card-banner">
                  <img src=".{{url('image/movie-8.png')}}" alt="Death on the Nile movie poster">
                </figure>
              </a>
          ...
          <li>
            <div class="movie-card">
              ...
              <a href="./movie-details.html">
                <figure class="card-banner">
                  <img src="{{url('image/movie-8.png')}}" alt="The King's Man movie poster">
                </figure>
              </a>
        ...
        <ul class="movies-list">
          ...
          <li>
            <div class="movie-card">
              ...
              <a href="./movie-details.html">
                <figure class="card-banner">
                  <img src="{{url('image/series-1.png')}}" alt="Moon Knight movie poster">
                </figure>
              </a>
          ...
          <li>
            <div class="movie-card">
              ...
              <a href="./movie-details.html">
                <figure class="card-banner">
                  <img src="{{url('image/series-2.png')}}" alt="Halo movie poster">
                </figure>
              </a>
          ...
          <li>
            <div class="movie-card">
              ...
              <a href="./movie-details.html">
                <figure class="card-banner">
                  <img src="{{url('image/series-3.png')}}" alt="Vikings: Valhalla movie poster">
                </figure>
              </a>
          ...
          <li>
            <div class="movie-card">
              ...
              <a href="./movie-details.html">
                <figure class="card-banner">
                  <img src="{{url('image/series-4.png')}}" alt="Money Heist movie poster">
                </figure>
              </a>
